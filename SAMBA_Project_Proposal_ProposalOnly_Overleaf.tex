...
The following screenshot is a preliminary dashboard view from the local React/Material UI interface. It intentionally shows only the small microbenchmark result from the proposal stage. Larger VGG19, ResNet50, ablation, and design-space results are listed as planned final work rather than completed proposal results.

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{docs/figures/proposal_dashboard_headline.png}
\caption{Proposal-stage React/Material UI dashboard showing only the preliminary microbenchmark result and the planned final work.}
\end{figure}
